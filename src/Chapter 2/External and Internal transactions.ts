...
async function main() {
    ...
    const walletAddress = Address.parse('0QAmzEMTk3SIjRAbMeJWDFYLNwkXp4P2Fu8iH0Pik5KOQUpJ');
    ...
    const client = new TonClient({
        ...
        apiKey: "257e0ed8af89337dcba257b628268cdeb5a9aeef239ab0c8d93e4e5547fc629a" // you can get an api key from @tonapibot bot in Telegram
    });

    const mnemonic = 'easy sunny senior'; // word1 word2 word3
